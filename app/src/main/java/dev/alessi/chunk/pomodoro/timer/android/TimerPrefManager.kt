...
//        edit.putLong(TimerState.KEY_TOTAL_TIME, timer.mTotalTime)
...
//        val mTotalTime = sharedPreferences.getLong(TimerState.KEY_TOTAL_TIME, 0)
//        val currentStatusOrdinal = sharedPreferences.getInt(TimerState.KEY_CURRENT_STATUS, 0)
//
//        return TimerState(currentTime, mTotalTime, TimerStatus.values()[currentStatusOrdinal])
//    }
